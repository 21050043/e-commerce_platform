              ...
              {relatedProducts.map((relatedProduct) => (
                ...
                >
                  <div className="h-56 overflow-hidden">
                    <img
                      src={relatedProduct.HinhAnh ? (relatedProduct.HinhAnh.startsWith('http') ? relatedProduct.HinhAnh : `${API_ROOT_URL}${relatedProduct.HinhAnh}`) : 'https://images.unsplash.com/photo-1501004318641-b39e6451bec6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80'}
